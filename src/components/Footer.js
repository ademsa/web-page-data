            ...
            <footer className="footer py-5">
                <div className="content has-text-centered grey-light">
                    <p className="has-text-weight-light my-0 is-size-7">
                        Source code available <a href="https://github.com/ademsa/web-page-data">here</a> (<a href="https://github.com/ademsa/web-page-data/blob/master/LICENSE.md">MIT license</a>).
                        <br />
